 ...
 *                   which is in line to the hoare partition scheme.
 ...
 *
 * Description: This is meant to use the last element of the partition as the pivot.
 ...
 * the array after each swap has been done of the two elements.
 */
void quick_sort_hoare(int *array, size_t size)
{
